...
def get_team_league(team_name):
    league_mappings = {
        "Premier League": [
            ...
            "Liverpool", "Man City", "Man United", "Newcastle", "Sunderland",
            "Tottenham", "Wolverhampton", "Burnley", "Leeds United", "Nottingham",
            "Crystal Palace", "Brighton Hove", "Brentford", "West Ham", "Bournemouth"
        ],
        "La Liga": [
            "Athletic", "Atleti", "Osasuna", "Espanyol", "Barça", "Getafe",
            "Real Madrid CF", "Rayo Vallecano", "Levante", "Mallorca", "Real Betis",
            "Real Sociedad", "Villarreal", "Valencia", "Alavés", "Elche",
            "Girona", "Celta", "Sevilla FC", "Real Oviedo"
        ],
        "Bundesliga": [
            "1. FC Köln", "Hoffenheim", "Leverkusen", "Dortmund", "Bayern",
            "HSV", "Stuttgart", "Wolfsburg", "Bremen", "Mainz", "Augsburg",
            "Freiburg", "M'gladbach", "Frankfurt", "St. Pauli", "Union Berlin",
            "Heidenheim", "RB Leipzig"
        ],
        "Serie A": [
            "Milan", "Fiorentina", "Roma", "Atalanta", "Bologna", "Cagliari",
            "Genoa", "Inter", "Juventus", "Lazio", "Parma", "Napoli",
            "Udinese", "Verona", "Cremonese", "Sassuolo", "AC Pisa", "Torino",
            "Lecce", "Como 1907"
        ],
        "Ligue 1": [
            "Toulouse", "Brest", "Marseille", "Auxerre", "Lille", "Nice",
            "Olympique Lyon", "PSG", "Lorient", "Stade Rennais", "Angers SCO",
            "Le Havre", "Nantes", "FC Metz", "RC Lens", "Monaco", "Strasbourg",
            "Paris FC"
        ],
        "Eredivisie": [
            "Twente", "Excelsior", "Heracles", "Heerenveen", "PSV", "Feyenoord",
            "Utrecht", "Groningen", "Ajax", "NAC", "AZ", "Zwolle", "Go Ahead",
            "Telstar", "NEC", "Volendam", "Sittard", "Sparta"
        ],
        "Primeira Liga": [
            "Rio Ave", "Sporting CP", "Porto", "Estoril Praia", "Moreirense",
            "Arouca", "Tondela", "SL Benfica", "CD Nacional", "Santa Clara",
            "Famalicão", "Gil Vicente", "Vitória SC", "Braga", "Casa Pia",
            "Alverca", "Amadora", "AVS"
        ],
        "Championship": [
